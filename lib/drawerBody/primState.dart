...
class PrimState extends StatefulWidget {
  @override
  _PrimStateState createState() => _PrimStateState();
}

class _PrimStateState extends State<PrimState> {
  ...
  _bodymessage(Map<String, dynamic> item) {
    countprim = widgetsListitem.length;
