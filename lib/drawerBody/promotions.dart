...
class PromotionsState extends StatefulWidget {
  @override
  _PromotionsStateState createState() => _PromotionsStateState();
}

class _PromotionsStateState extends State<PromotionsState> {
  ...
  _bodymessage(Map<String, dynamic> item) {
    setState(() {
      countPromotions = widgetsListitem.length;
    });
